...
class RenderDataPose extends StatefulWidget {
...
class _RenderDataState extends State<RenderDataPose> {
  late Map<String, List<double>> inputArr;

  String excercise = 'Yoga';
